    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ml-2 sm:flex">
                    <x-nav-link :href="route('MyUsers')" :active="request()->routeIs('MyUsers')" wire:navigate>
                        {{ __('MyUsers') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-2 sm:-my-px sm:ml-2 sm:flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ml-2 sm:flex">
                    <x-nav-link :href="route('MyPermissions')" :active="request()->routeIs('MyPermissions')" wire:navigate>
                        {{ __('MyPermissions') }}
                    </x-nav-link>
                </div>
